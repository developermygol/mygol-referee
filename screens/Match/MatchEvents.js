...
const MatchEvent = withNavigation(
  observer(
    class MatchEventClass extends Component {
      ...
      getPlayerNameLink = (idPlayer, textAlign) => {
        ...
        return (
          <View style={style.PlayerName}>
            <Text style={[style.TouchablePlayerName, { textAlign }]}>
        ...
        switch (eventType) {
          ...
          case 61:
            return (
              <Ionicons
                style={style.EventIcon}
                name={getIconPrefix() + 'square'}
                size={26}
                color={gColors.cardsType1}
              />
            ); // yellow card
          case 62:
            return (
          ...
          case 33:
            return (
              <Ionicons
                style={style.EventIcon}
                name={getIconPrefix() + 'flag'}
                size={26}
                color={gColors.text1}
              />
            ); // corner
          default:
            return <Text style={style.EventIcon}>{this.getEventText(eventType, match)}</Text>;
        }
      };
      ...
      renderLeft = () => {
        ...
        return (
          <TouchableOpacity style={style.Event} onPress={this.handleEventPress}>
            ...
            {this.getEventImage(event.type, match)}
